 ...
 * @since 4.0.0
 */
public class KeyVaultEnvironmentPostProcessorImpl implements EnvironmentPostProcessor, Ordered {
     ...
     */
    public KeyVaultEnvironmentPostProcessorImpl(Log logger) {
        this.logger = logger;
    }
     ...
     */
    public KeyVaultEnvironmentPostProcessorImpl() {
